		...
		<logic:iterate name="users" id="u" indexId="i">
			<pg:item>
				<tr>
					...
					<td><a
						href="/blog/admin/blogUser.do?act=load&id=<bean:write name="u" property="id"/>">[[ALTERAR]]</a>
					<a
						href="/blog/admin/blogUser.do?act=delete&id=<bean:write name="u" property="id"/>">[[DELETAR]]</a>
					<c:choose>
						<c:when test="${u.status == 1}">
							<a
