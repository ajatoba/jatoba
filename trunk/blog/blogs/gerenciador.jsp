        ...
        <th width="268" align="left" valign="top" scope="row"><table width="268" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="33" valign="bottom">
                ...
                <input name="login" type="text" id="login" style=" height:28px; border:1px solid #B7D3E9; width:232px; background-color:#F8F8F8; font-size:19px; padding-left:3px; color:#147ABA;" onKeyDown="if(event.keyCode==13) blogUserForm.submit();"></td>
          </tr>
          <tr>
