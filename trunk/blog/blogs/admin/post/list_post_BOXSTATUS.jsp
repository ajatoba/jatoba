...
<div id="top_repeat">
	<div id="top">
		...
		<div class="logo"></div>
		<div class="links"><img src="/bloglog/admin/imgs/btn_posts.jpg" /><img src="/bloglog/admin/imgs/btn_ajuda.jpg" /></div>
		<div class="login"></div>
	</div>
</div>
<div id="barra_repeat">
	<div id="barra">
        ...
        <a href="/blog/blogs/admin/favorites.do?act=list"  style="text-decoration:none;"><span>&nbsp;FAVORITOS&nbsp;</a>
...
<tr>
		...
		<table width="780" border="0" cellpadding="0" cellspacing="0" style="border-bottom:1px solid #147AB8;">
		  <tr>
			...
			<td width="118"><span class="style14">&nbsp;
			  <select name="status" onChange="document.location=this.value;" style="width:100px; font-size:10px;" value='${post.status}'>
  <option value="1" style="color:#00CC00; font-weight:bold;">Ativo</option>
  <option value="0" style="color:#FF0000; font-weight:bold;">Inativo</option>
</select>
  ...
  <option value='/blog/blogs/admin/post.do?act=delete&id=<bean:write name="p" property="id"/>'>Excluir</option>
		    ...
		    <td width="61" align="left" valign="middle"><span class="style14">&nbsp;&nbsp;123</span></td>
